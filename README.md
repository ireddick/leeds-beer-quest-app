...
The app is built with TypeScript, React and Next.js using the default `create-next-app` codebase as a starter with CSS modules for styling. Test infrastructure using Jest was subsequently added as per the current Next.js documentation. React component tests use React Testing Library.
